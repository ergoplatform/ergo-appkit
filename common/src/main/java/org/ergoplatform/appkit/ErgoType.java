...
public class ErgoType<T> {
    ...
    private static ErgoType<sigma.SigmaProp> _sigmaProp = new ErgoType(JavaHelpers.SigmaPropRType());
    ...
    private static ErgoType<sigma.PreHeader> _preHeader = new ErgoType(JavaHelpers.PreHeaderRType());
    ...
    static public ErgoType<sigma.SigmaProp> sigmaPropType() { return _sigmaProp; }
    ...
    static public ErgoType<sigma.PreHeader> preHeaderType() { return _preHeader; }
