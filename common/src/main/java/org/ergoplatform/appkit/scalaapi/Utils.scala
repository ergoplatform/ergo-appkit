...
object Utils {
  ...
  /** Converts a Map to a tuple of arrays, where the first array contains all keys of the map
    * and the second array contains all values of the map.
    *
    * @tparam K the type of keys in the map.
    * @tparam V the type of values in the map.
    * @param m the Map to convert to arrays.
    * @return a tuple, where the first array contains all keys of the map
    *         and the second array contains all values of the map.
    */
